...
public class HandlingEventFactory {
   ...
   */
  public HandlingEvent createHandlingEvent(ZonedDateTime registrationTime, ZonedDateTime completionTime, TrackingId trackingId, VoyageNumber voyageNumber, UnLocode unlocode, HandlingEvent.Type type)
